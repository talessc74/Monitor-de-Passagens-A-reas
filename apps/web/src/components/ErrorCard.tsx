  ...
  return (
    <div className="mb-6 rounded-2xl border border-red-100 bg-red-50 p-4">
      ...
      <button
        onClick={onRetry}
        disabled={retrying}
        className="mt-3 flex items-center gap-1.5 rounded-lg border border-red-300 bg-white px-3 py-1.5 text-xs font-bold text-red-700 transition hover:bg-red-100 disabled:opacity-60"
      >
